...
from core.logic import LogicAdapter
from core.search import IndexedTextSearch
...
class ChatBot(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        storage_adapter = kwargs.get('storage_adapter', 'core.storage.SQLStorageAdapter')

        logic_adapters = kwargs.get('logic_adapters', [
            'core.logic.BestMatch'
        ])
    ...
    def get_latest_response(self, conversation):
        ...
        """
        from core.conversation import Statement as StatementObject
